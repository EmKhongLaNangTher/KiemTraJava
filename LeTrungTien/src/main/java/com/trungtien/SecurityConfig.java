package com.trungtien;

import com.trungtien.service.UserService;
    ...
    public SecurityFilterChain securityFilterChain(@NotNull HttpSecurity http) throws Exception {
        return http
                ...
                .formLogin(formLogin -> formLogin
                        ...
                        .failureUrl("/nhanviens?error") // Trang đăng nhập thất bại.
                        .permitAll()
                )
                .rememberMe(rememberMe -> rememberMe
                        .key("huu")
                        .rememberMeCookieName("huu")
                ...
                .httpBasic(httpBasic -> httpBasic
                        .realmName("huu") // Tên miền cho xác thực cơ bản.
                )
